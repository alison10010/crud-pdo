...
<div class="container">
    ...
    <form method="post">
        <div class="form-group">
            ...
            <input type="txt" class="form-control" id="titulo" name="titulo" value="<?=$obVaga->titulo?>" required>
        </div>

        <div class="form-group">
            <label for="descricao">Descricao da vaga:</label>
            <textarea type="txt" class="form-control" id="descricao" name="descricao" required><?=$obVaga->descricao?></textarea>
        </div>
